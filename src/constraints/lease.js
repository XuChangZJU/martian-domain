...
var ableToArrearsLease = function ableToArrearsLease(data) {
    ...
    if (treatment === Treatment.personal && [LeaseState.implementation, LeaseState.willCompleted].includes(leaseState)) {
        return true;
    }
    return false;
};
...
var ableToCancelArrearsLease = function ableToCancelArrearsLease(data) {
    ...
    if (treatment === Treatment.personal && leaseState === LeaseState.arrearage) {
        return true;
    }
    return false;
};
