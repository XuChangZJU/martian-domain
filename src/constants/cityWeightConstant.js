...
const Third_Tier_Cities = ["潍坊", "保定", "镇江", "扬州", "桂林", "唐山", "三亚", "湖州", "呼和浩特", "廊坊", "洛阳", "威海", "盐城", "临沂", "江门", "汕头", "泰州", "漳州", "邯郸", "济宁", "芜湖", "淄博", "银川", "柳州", "绵阳", "湛江", "鞍山", "赣州", "大庆", "宜昌", "包头", "咸阳", "秦皇岛", "株洲", "莆田", "吉林", "淮安", "肇庆", "宁德", "衡阳", "南平", "连云港", "丹东", "丽江", "揭阳", "延边", "舟山", "九江", "龙岩", "沧州", "抚顺", "襄阳", "上饶", "营口", "三明", "蚌埠", "丽水", "岳阳", "清远", "荆州", "泰安", "衢州", "盘锦", "东营", "南阳", "马鞍山", "南充", "西宁", "孝感", "齐齐哈尔"];

const Forth_Tier_Cities = ["乐山", "湘潭", "遵义", "宿迁", "新乡", "信阳", "滁州", "锦州", "潮州", "黄冈", "开封", "德阳", "德州", "梅州", "鄂尔多斯", "邢台", "茂名", "大理", "韶关", "商丘", "安庆", "黄石", "六安", "玉林", "宜春", "北海", "牡丹江", "张家口", "梧州", "日照", "咸宁", "常德", "佳木斯", "红河", "黔东南", "阳江", "晋中", "渭南", "呼伦贝尔", "恩施", "河源", "郴州", "阜阳", "聊城", "大同", "宝鸡", "许昌", "赤峰", "运城", "安阳", "临汾", "宣城", "曲靖", "西双版纳", "邵阳", "葫芦岛", "平顶山", "辽阳", "菏泽", "本溪", "驻马店", "汕尾", "焦作", "黄山", "怀化", "四平", "榆林", "十堰", "宜宾", "滨州", "抚州", "淮南", "周口", "黔南", "泸州", "玉溪", "眉山", "通化", "宿州", "枣庄", "内江", "遂宁", "吉安", "通辽", "景德镇", "阜新", "雅安", "铁岭", "承德", "娄底"];
