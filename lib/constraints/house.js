...
var ableToTransferHouse = function ableToTransferHouse(data) {
    ...
    return ![HouseState.shadow, HouseState.rented, HouseState.ordered, HouseState.willFree, HouseState.willOffline].includes(state) && [HouseCategory.house, HouseCategory.flatShare, HouseCategory.apartment, HouseCategory.tavern, HouseCategory.hotel].includes(category);
};
