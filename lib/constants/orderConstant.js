...
var STRING_OF_STATES = (_STRING_OF_STATES = {}, _STRING_OF_STATES[state.unpaid] = '待支付', _STRING_OF_STATES[state.paying] = '支付中', _STRING_OF_STATES[state.partialPaid] = '部分支付', _STRING_OF_STATES[state.paid] = '支付成功', _STRING_OF_STATES[state.toBeRefunded] = '退款中', _STRING_OF_STATES[state.refunding] = '退款中', _STRING_OF_STATES[state.refunded] = '退款成功', _STRING_OF_STATES[state.closed] = '已关闭', _STRING_OF_STATES[state.finished] = '已完成', _STRING_OF_STATES);
