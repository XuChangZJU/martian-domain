...
var externalHouseCheckResultDecoder = function externalHouseCheckResultDecoder(checkResult) {
    ...
    var EXTERNALHOUSE_CHECKRESULT_STRING = (_EXTERNALHOUSE_CHECKR = {}, _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.noYetValidated] = '尚未验真', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.uncooperative] = '一房东不愿合作', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.searchRoommate] = '非房东，寻找合租室友', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.willingToPayServiceCharge] = '暂时不愿装锁，愿意付服务费', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.willingToInstallLock] = '一房东愿意装锁', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.headLesseeWillingToInstallLock] = '二房东愿意装锁', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.headLesseeUncooperative] = '二房东不愿合作', _EXTERNALHOUSE_CHECKR[externalHouseCheckResult.sublease] = '非房东，转租房屋', _EXTERNALHOUSE_CHECKR);
...
var calcTax = function calcTax(price, ratio) {
