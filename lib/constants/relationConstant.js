...
var relationStateDecoder = function relationStateDecoder(state) {
    ...
    var RELATION_STATE_STRING = (_RELATION_STATE_STRIN = {}, _RELATION_STATE_STRIN[relationState.active] = '活跃的', _RELATION_STATE_STRIN[relationState.willDisabled] = '禁用的', _RELATION_STATE_STRIN[relationState.disabled] = '师兄啊', _RELATION_STATE_STRIN);
