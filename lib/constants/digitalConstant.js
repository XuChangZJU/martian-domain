...
var decodeActionState = function decodeActionState(s) {
    ...
    var STRING_OF_STATE = (_STRING_OF_STATE2 = {}, _STRING_OF_STATE2[state.dirty] = '未同步', _STRING_OF_STATE2[state.opaque] = '不明', _STRING_OF_STATE2[state.clean] = '已同步', _STRING_OF_STATE2);
...
var decodeActionResult = function decodeActionResult(r) {
    var _STRING_OF_RESULT;

    var STRING_OF_RESULT = (_STRING_OF_RESULT = {}, _STRING_OF_RESULT[actionResult.success] = '已成功', _STRING_OF_RESULT[actionResult.keyWordValidateFail] = '验证密码失败', _STRING_OF_RESULT[actionResult.flashReadingError] = '读flash失败', _STRING_OF_RESULT[actionResult.flashWritingError] = '写flash失败', _STRING_OF_RESULT[actionResult.actionDisallowed] = '操作被拒绝', _STRING_OF_RESULT[actionResult.commandUnrecognized] = '不能识别的命令', _STRING_OF_RESULT[actionResult.paramLengthIllegal] = '参数不合法', _STRING_OF_RESULT[actionResult.dataInconsistency] = '数据不一致', _STRING_OF_RESULT[!actionResult.notEnoughMemory] = '内存不足', _STRING_OF_RESULT);
